      ...
      return Transform.scale(
        ...
        child: Row(
         ...
         //  if(!Responsive.isLargeMobile(context)) NavigationTextButton(onTap: () {}, text: 'About Me'),
            ...
            NavigationTextButton(onTap: () {controller.animateToPage(2, duration: const Duration(milliseconds: 500), curve: Curves.easeIn);}, text: 'Education'),
          //  NavigationTextButton(onTap: () {}, text: 'Accomplishments'),
          ],
        ),
      );
    },);
