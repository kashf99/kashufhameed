              ...
              children: [
                ...
                const SizedBox(height: defaultPadding,),
                 Text.rich(
                  maxLines: 3,
                  TextSpan(
                      text: certificateList[index].organization,style: const TextStyle(color: Color.fromARGB(255, 77, 166, 240)),
                      children: [
                        TextSpan(
                          text: "\n${certificateList[index].date}",style: const TextStyle(color: Colors.grey,
                          fontSize: 10,
                          overflow: TextOverflow.ellipsis,),)
                      ]
                  ),),
